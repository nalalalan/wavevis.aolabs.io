...
\caption{Current source-rendered Front view for the same default state. This separate product camera now compresses front depth, bounds the terminal lip contribution, keeps rounded terminal width, and dips the lip underside through the center using continuous contours on the same surface instead of the discarded pasted cap layer. It removes the raised shelf artifact but remains open against the June 24 front reference.}
