...
\caption{Current source-rendered Front view for the same default state. This view was added as a separate product camera so the spanwise mound and lip-cap read can be checked directly against the June 24 three-view reference.}
