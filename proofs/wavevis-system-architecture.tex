...
\begin{itemize}
  \item Candidate876 is source/build/PDF/live-route verified for publication, not final reference proof. The rebuilt PDF was copied into the public proof paths; the fallback and standalone HTTP routes served \pathcode{index-SPBHkj_l.js} during the July 1, 2026 check.
