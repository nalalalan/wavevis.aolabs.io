...
\caption{Current source-rendered Front view for the same default state. This separate product camera now shows a cleaner spanwise mound check without the earlier dark jagged trace, but it remains open against the June 24 front reference.}
