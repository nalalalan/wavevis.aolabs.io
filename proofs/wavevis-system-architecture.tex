...
\begin{enumerate}
  \item sanitize rows, columns, visible sliders, display flags, and URL parameters;
...
\code{noVisibleDimplePocket} & Lip tuck and return ratios in the centerline curl. & The tip may curl under, but it must not form a tight pucker, pocket, or enclosed bowl. \\
\bottomrule
\end{tabular}
}
