...
\begin{itemize}
  ...
  \item Source-rendered side, reference-overlay, isometric, top, and cross-section figures were regenerated from the passing geometry model. Current source metrics are \(4928\) rendered nodes, \(9700\) rendered edges, zero rendered-neighbor residual, zero bowl pockets, default reference-trace max residual \(0.0956\), reference-trace RMS residual \(0.0604\), terminal-drop ratio \(0.947\), default top-footprint collapse ratio \(1.043\), max height \(12.81\), and max tensile strain \(3.88\).
\end{itemize}
