...
function summarizeReadableSurfaceRenderContract() {
  ...
  const requiredFragments = [
    ...
    ['3D-only lower lip moves forward and down without changing side/top surfaces', 'point[0] + waveWidth * openThroat * (0.064 * lipFace + 0.052 * lowerLip - 0.032 * throat)'],
    ['3D-only throat lift keeps the opening readable without a fake shadow patch', 'point[2] + frame.height * openThroat * (0.082 * throat - 0.205 * lowerLip)'],
    ...
    ['readable profile uses the current rounded open-throat curl family', '0.684,0.948;0.726,0.848;0.758,0.694'],
  ]
