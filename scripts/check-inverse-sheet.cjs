...
function summarizeReadableSurfaceRenderContract() {
  ...
  const requiredFragments = [
    ...
    ['side lower lip opens forward without a wall-cut branch', 'point[0] + waveWidth * openThroat * (0.04 * lipFace + 0.092 * lowerLip - 0.026 * throat)'],
    ['side throat lift keeps the lower lip from becoming a fake-cavity branch', 'point[2] + frame.height * openThroat * (0.072 * throat - 0.04 * lowerLip)'],
    ...
    ['3D-only lower lip moves forward without changing front/top surfaces', 'point[0] + waveWidth * openThroat * (0.058 * lipFace + 0.088 * lowerLip - 0.026 * throat)'],
    ['3D-only throat lift keeps the opening readable without a fake shadow patch', 'point[2] + frame.height * openThroat * (0.096 * throat - 0.09 * lowerLip)'],
